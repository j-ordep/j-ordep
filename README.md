...
- Golang, Typescript, C# .NET, Angular, Java, Spring, SQL, Docker, Git.

[![My Skills](https://skillicons.dev/icons?i=go,typescript,cs,dotnet,angular,java,postgresql,docker)](https://skillicons.dev)
